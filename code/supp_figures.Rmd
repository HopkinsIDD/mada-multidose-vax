...
The date, type of activity (Supplemental Immunization Activity (SIA) or Vaccination Week, vaccine, and age target for non-routine activities is shown. Routine vaccines include those for measles,diphtheria, pertussis, tetanus, Hepatitis B infection, Haemophilius influenzae (Hib) infection, pneumococcal disease,  rotavirus infection, and poliovirus. 
...
## Web Figure 1: Monthly number of doses given in six study districts according to the National Administrative database, 2013-2018
...
## Web Figure 2: Process of curating the analysis data set for the vaccination card database

Steps to create a final analysis data set included 1) removing all cards for children that were not born in 2015 and 2016, 
2) removing cards with evidence of later doses being given without evidence of prior doses, 3) removing all cards with vaccination dates that were out of order, and 4) removing all cards where there’s evidence of a vaccination occurring but no date is listed.

![ ](../figures/supp_figures/figureS2_data_cleaning.png){width=500px}
  
\pagebreak

## Web Appendix 1: Calculation of vaccination coverage and proportion late from vaccination card database
...
![ ](../figures/supp_figures/eqnS1_weightexample0.png){width=300px}
...
![ ](../figures/supp_figures/eqnS1_weightexample1.png){width=300px}
We can then implement the equation above to estimate the second dose weights for each individual (i.e. $w_{2i}$):

![ ](../figures/supp_figures/eqnS1_weightexample2.png){width=300px}
...
![Routine vaccination model graph.](../figures/supp_figures/eqnS3_routineGraph.png)
...
![Vaccination week model graph.](../figures/supp_figures/eqnS3_modelGraph.png)
...
## Web Figure 4: Estimates of vaccination coverage at one-year of age and proportion of children receiving late doses for rotavirus vaccine by district and birth month
...
## Web Figure 5: Kaplan-Meier curves for each vaccine and dose using the vaccination card database
...
## Web Figure 6: Weekly rates of vaccination used in the simulation
